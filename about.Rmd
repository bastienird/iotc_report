...
qflextable2(raisingfactorfromnumber_to_nominal_t_and_no_10_kilos_groupped, caption = paste0("Number of strata inferior/superior to 10 kilo for analysis", toString(c("species", "year", "fishing_fleet", "gear_type"))))
```

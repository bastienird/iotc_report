...
```{r fig.cap="Nombre de strates avec un facteur de conversion de plus ou de moins de 1 kilos (strate espèces/année/pavillon)"}

qflextable2(raisingfactorfromnumber_to_nominal_t_and_no)

...
if (!file.exists(here::here("data/global_nominal_catch_firms_level0_harmonized.csv"))) {
  ...
  zen4R::download_zenodo("10.5281/zenodo.11410529", "global_nominal_catch_firms_level0_harmonized.csv", path = "data")
            nominal_init <- readr::read_csv(here::here("data/global_catch_firms_level0_harmonized.csv"))
} else {
...
if (!file.exists(here::here("data/global_catch_firms_level0_harmonized.csv"))) {
  # Télécharger le fichier si nécessaire
    zen4R::download_zenodo("10.5281/zenodo.11460074", "global_catch_firms_level0_harmonized.csv", path = "data")
